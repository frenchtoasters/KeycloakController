...
manifests: controller-gen ## Generate WebhookConfiguration, ClusterRole and CustomResourceDefinition objects.
	$(CONTROLLER_GEN) rbac:roleName=manager-role crd webhook paths="./..." crd:allowDangerousTypes=true output:crd:artifacts:config=config/crd/bases 
...
.PHONY: kind-delete
kind-delete: ## Destroys the "keycloak" kind cluster.
...
delete-cluster: delete-workload-cluster  ## Deletes the example kind cluster "keycloak"
	kind delete cluster --name=$(KIND_CLUSTER_NAME)
